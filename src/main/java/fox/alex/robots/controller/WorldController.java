 ...
 * - если задача отправляется лично роботу, а он занят, то сосздается новый робот такого же типа и ему отправляется эта задача;
 * - если задача отправляется всем роботам и кто-то из них занят, то он игнорирует ее, остальные начинаюи выполнять,
